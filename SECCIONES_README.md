...
```html
<form action="/suscripcion_handler.cgi" method="POST"></form>
```
...
```html
<a href="/media-kit.pdf" download></a>
```
...
<meta
  name="description"
  content="Suscribite a VETAS, la revista líder de la industria maderera en Latinoamérica"
/>
<meta
  name="keywords"
  content="revista vetas, industria madera, suscripción, publicidad"
/>
...
<meta
  ...
  content="La revista líder del sector desde 1980"
/>
